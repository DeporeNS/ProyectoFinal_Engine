...
Obstacle::Obstacle() {
	...
	//Player
	mPlayer = new Player();
	mPlayer->changeState(7);

	//Enemy
	mEnemy1 = new Enemy();
	mEnemy1->changeState(7);

	//Logo
	mLogo = new Texture("Obstacle", "Lazer84.TTF", 110, { 140, 0, 0 });
	mLogo2 = new Texture("Obstacle", "Lazer84.TTF", 110, { 140, 81, 0 });
	mLogo3 = new Texture("Obstacle", "Lazer84.TTF", 110, { 140, 157, 0 });
	mLogo->Parent(this);
	mLogo2->Parent(this);
	mLogo3->Parent(this);
	mLogo->Pos(Vector2(Graphics::Instance()->SCREEN_WIDTH * 0.175f, Graphics::Instance()->SCREEN_HEIGHT * 0.35f));
	mLogo2->Pos(Vector2(Graphics::Instance()->SCREEN_WIDTH * 0.175f, Graphics::Instance()->SCREEN_HEIGHT * 0.35f));
	mLogo3->Pos(Vector2(Graphics::Instance()->SCREEN_WIDTH * 0.175f, Graphics::Instance()->SCREEN_HEIGHT * 0.35f));
