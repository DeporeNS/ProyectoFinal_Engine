...
Hide::Hide() {
	...
	//Player
	mPlayer = new Player();
	mPlayer->changeState(10);

	//Logo
	mLogo = new Texture("Hide", "Lazer84.TTF", 120, { 140, 0, 0 });
	mLogo2 = new Texture("Hide", "Lazer84.TTF", 120, { 140, 81, 0 });
	mLogo3 = new Texture("Hide", "Lazer84.TTF", 120, { 140, 157, 0 });
	mLogo->Parent(this);
	mLogo2->Parent(this);
	mLogo3->Parent(this);
