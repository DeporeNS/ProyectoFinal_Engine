...
Seek::Seek() {
	...
	//Player
	mPlayer = new Player();
	mPlayer->changeState(1);
	//mPlayer->Parent(mFondo);
	//mPlayer->Pos(VEC2_ZERO);

	//Logo
	mLogo = new Texture("Seek", "Lazer84.TTF", 120, { 140, 0, 0 });
	mLogo2 = new Texture("Seek", "Lazer84.TTF", 120, { 140, 81, 0 });
	mLogo3 = new Texture("Seek", "Lazer84.TTF", 120, { 140, 157, 0 });
	mLogo->Parent(this);
	mLogo2->Parent(this);
	mLogo3->Parent(this);
