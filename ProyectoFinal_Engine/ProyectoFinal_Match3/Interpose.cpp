...
Interpose::Interpose() {
	...
	//Player
	mPlayer = new Player();
	mPlayer->changeState(9);

	//Enemy
	mEnemy = new Enemy();
	mEnemy->changeState(9);

	//Logo
	mLogo = new Texture("Interpose", "Lazer84.TTF", 110, { 140, 0, 0 });
	mLogo2 = new Texture("Interpose", "Lazer84.TTF", 110, { 140, 81, 0 });
	mLogo3 = new Texture("Interpose", "Lazer84.TTF", 110, { 140, 157, 0 });
	mLogo->Parent(this);
	mLogo2->Parent(this);
	mLogo3->Parent(this);
	mLogo->Pos(Vector2(Graphics::Instance()->SCREEN_WIDTH * 0.18f, Graphics::Instance()->SCREEN_HEIGHT * 0.35f));
	mLogo2->Pos(Vector2(Graphics::Instance()->SCREEN_WIDTH * 0.18f, Graphics::Instance()->SCREEN_HEIGHT * 0.35f));
	mLogo3->Pos(Vector2(Graphics::Instance()->SCREEN_WIDTH * 0.18f, Graphics::Instance()->SCREEN_HEIGHT * 0.35f));
...
void Interpose::Update() {
	...
	mPlayer->Update();
	mEnemy->Update(mPlayer->Pos);
}

// Render
void Interpose::Render() {
	fondo->Render();
