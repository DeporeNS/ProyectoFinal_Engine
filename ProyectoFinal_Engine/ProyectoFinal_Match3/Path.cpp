...
Path::Path() {
	...
	//Player
	mPlayer = new Player();
	mPlayer->changeState(11);

	//Logo
	mLogo = new Texture("Path", "Lazer84.TTF", 120, { 140, 0, 0 });
	mLogo2 = new Texture("Path", "Lazer84.TTF", 120, { 140, 81, 0 });
	mLogo3 = new Texture("Path", "Lazer84.TTF", 120, { 140, 157, 0 });
	mLogo->Parent(this);
	mLogo2->Parent(this);
	mLogo3->Parent(this);
