...
Evade::Evade() {
	...
	//Player
	mPlayer = new Player();
	mPlayer->changeState(2);

	//Enemy
	mEnemy = new Enemy();
	mEnemy->changeState(2);

	//Logo
	mLogo = new Texture("Evade", "Lazer84.TTF", 120, { 140, 0, 0 });
	mLogo2 = new Texture("Evade", "Lazer84.TTF", 120, { 140, 81, 0 });
	mLogo3 = new Texture("Evade", "Lazer84.TTF", 120, { 140, 157, 0 });
	mLogo->Parent(this);
	mLogo2->Parent(this);
	mLogo3->Parent(this);
