...
Pursuit::Pursuit() {
	...
	//Player
	mPlayer = new Player();
	mPlayer->changeState(4);

	//Enemy
	mEnemy = new Enemy();
	mEnemy->changeState(4);

	//Logo
	mLogo = new Texture("Pursuit", "Lazer84.TTF", 120, { 140, 0, 0 });
	mLogo2 = new Texture("Pursuit", "Lazer84.TTF", 120, { 140, 81, 0 });
	mLogo3 = new Texture("Pursuit", "Lazer84.TTF", 120, { 140, 157, 0 });
	mLogo->Parent(this);
	mLogo2->Parent(this);
	mLogo3->Parent(this);
